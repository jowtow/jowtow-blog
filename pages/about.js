      ...
      <Layout pageTitle={`${title} | About`} description={description}>
        <div className={styles.aboutContainer}>
          ...
          <div className={styles.links}>
            ...
            <a href="https://open.spotify.com/user/1226496424?si=a0b619d607b9491e" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faSpotify} /></a>
            <a href="https://twitter.com/jowtow" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faTwitter} /></a>
          </div>
        </div>
      </Layout>
    </>
